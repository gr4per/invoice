...
const InvoiceImportMarkup = ({ onImport, importInProgress, importPercentage, importResult, cleanImportResult }, { i18n }) => (
  <div>
    <h1>{i18n.getMessage('InvoiceImport.header')}</h1>
    <InvoiceImportDropzone onImport={onImport}/>
    <br/>
    {importInProgress && <ProgressBar active now={importPercentage} label={`${importPercentage}%`}/>}
